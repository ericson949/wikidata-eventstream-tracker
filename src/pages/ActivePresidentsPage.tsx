    ...
    <div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="bg-emerald-50 text-emerald-800 border-emerald-300 text-xs px-3 py-1 font-semibold">
            {activePresidents.length} Présidents en fonction
          </Badge>
        </div>
        ...
        <div className="border-b border-slate-200 pb-3">
          <h2 className="text-2xl font-bold font-serif text-slate-900 flex items-center gap-3">
            ...
            Tous les Présidents en fonction
          </h2>
          <p className="text-xs text-slate-500 mt-1">Liste complète des chefs d'État actuellement en exercice en Afrique, classés par votes puis par nom.</p>
        </div>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="relative flex flex-1 items-center rounded-lg border border-slate-200 bg-white px-3 py-1 shadow-sm w-full md:w-auto">
            ...
            <input
              type="text"
              placeholder="Rechercher un président en fonction..."
              value={publicSearch}
        ...
        {loading ? (
          ...
          <div className="py-20 text-center text-slate-500 font-medium">Aucun président en fonction trouvé pour cette recherche.</div>
        ) : (
          <div className="space-y-6">
            ...
            <PaginationControls
              ...
              totalPages={Math.ceil(activePresidents.length / publicPageSize) || 1}
              pageSize={publicPageSize}
              totalItems={activePresidents.length}
