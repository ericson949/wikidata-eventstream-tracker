...
>(({ className, children, onClear, hasValue, ...props }, ref) => (
  <div className="relative flex items-center">
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex h-10 w-full items-center justify-between rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 ring-offset-background placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 gap-2",
    ...
    >
      ...
      {hasValue && onClear && (
        <button
          ...
          className="text-slate-400 hover:text-red-600 focus:outline-none p-1 rounded hover:bg-slate-100"
